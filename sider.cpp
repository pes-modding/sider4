...
HRESULT sider_CreateSwapChain(IDXGIFactory1 *pFactory, IUnknown *pDevice, DXGI_SWAP_CHAIN_DESC *pDesc, IDXGISwapChain **ppSwapChain)
{
    ...
    //_swap_chain->SetFullscreenState(TRUE, NULL);
...
#define NUM_PATTERNS 18
    ...
    frag[10] = pattern_sider_1;
    frag[11] = pattern_sider_2;
    frag[12] = pattern_sider_3;
    frag[13] = pattern_sider_4;
    frag[14] = pattern_dxgi;
    frag[15] = pattern_ball_name;
    frag[16] = pattern_stadium_name;
    frag[17] = pattern_set_stadium_choice;
    frag[18] = pattern_xinput;

    memset(_variations, 0xff, sizeof(_variations));
    _variations[0] = 0;

    size_t frag_len[NUM_PATTERNS+1];
    frag_len[1] = _config->_lua_enabled ? sizeof(lcpk_pattern_at_read_file)-1 : 0;
    frag_len[2] = _config->_lua_enabled ? sizeof(lcpk_pattern_at_get_size)-1 : 0;
    frag_len[3] = _config->_lua_enabled ? sizeof(lcpk_pattern_at_write_cpk_filesize)-1 : 0;
    frag_len[4] = _config->_lua_enabled ? sizeof(lcpk_pattern_at_mem_copy)-1 : 0;
    frag_len[5] = _config->_lua_enabled ? sizeof(lcpk_pattern_at_lookup_file)-1 : 0;
    ...
    frag_len[10] = _config->_lua_enabled ? sizeof(pattern_sider_1)-1 : 0;
    frag_len[11] = _config->_lua_enabled ? sizeof(pattern_sider_2)-1 : 0;
    frag_len[12] = _config->_lua_enabled ? sizeof(pattern_sider_3)-1 : 0;
    frag_len[13] = _config->_lua_enabled ? sizeof(pattern_sider_4)-1 : 0;
    frag_len[14] = _config->_overlay_enabled ? sizeof(pattern_dxgi)-1 : 0;
    frag_len[15] = _config->_lua_enabled ? sizeof(pattern_ball_name)-1 : 0;
    frag_len[16] = _config->_lua_enabled ? sizeof(pattern_stadium_name)-1 : 0;
    frag_len[17] = _config->_lua_enabled ? sizeof(pattern_set_stadium_choice)-1 : 0;
    frag_len[18] = _config->_lua_enabled ? sizeof(pattern_xinput)-1 : 0;
    ...
    offs[10] = offs_sider_1;
    offs[11] = offs_sider_2;
    offs[12] = offs_sider_3;
    offs[13] = offs_sider_4;
    offs[14] = offs_dxgi;
    offs[15] = offs_ball_name;
    offs[16] = offs_stadium_name;
    ...
    addrs[10] = &_config->_hp_at_sider_1;
    addrs[11] = &_config->_hp_at_sider_2;
    addrs[12] = &_config->_hp_at_sider_3;
    addrs[13] = &_config->_hp_at_sider_4;
    addrs[14] = &_config->_hp_at_dxgi;
    addrs[15] = &_config->_hp_at_ball_name;
    addrs[16] = &_config->_hp_at_stadium_name;
    addrs[17] = &_config->_hp_at_set_stadium_choice;
    addrs[18] = &_config->_hp_at_xinput;
