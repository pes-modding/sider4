...
local tests = {
    ...
    { "l", '\x10\x20\x30\x40\x87\xd6\x12\x30', 0x3012d68740302010LL, 0, },
    { "l", '\xfd\xff\xff\xff\xff\xff\xff\xff', -3LL, 0, },
    { "i", '\x87\xd6\x12\x00', 1234567, 0, },
    { "s", '\x39\x30', 12345, 0, },
    { "ul",'\x10\x20\x30\x40\x87\xd6\x12\xcf', 0xcf12d68740302010ULL, 0, },
    { "ul",'\x00\x01\x00\x00\x00\x00\x00\x00', 0x100ULL, 0, },
...
function init(ctx)
    ...
    local n1 = memory.unpack("l", s)
    local n2 = memory.unpack("ul", s)
